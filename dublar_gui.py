...
RESOLUTIONS = ["720", "1080", "480", "360", "144", "best"]
BROWSERS = ["", "edge", "chrome", "firefox", "brave", "opera"]
ENGINES = {"Chatterbox (clonagem)": "chatterbox", "Edge TTS (leve)": "edge"}
...
class DublarGUI(ctk.CTk):
    def __init__(self):
        ...
        self.var_engine = tk.StringVar(value=cfg.get("engine", "chatterbox"))
    ...
    def _draw_header(self):
        ...
        self.header.coords("theme_btn", self.header.winfo_width() - 8, 44)
    ...
    def _build_options_section(self, body, row):
        ...
        opts = [
            ...
            ("Motor de dublagem", self.var_engine, ENGINE_LABELS),
        ]
    ...
    def _engine_value(self):
        return ENGINES.get(self.var_engine.get(), "chatterbox")
