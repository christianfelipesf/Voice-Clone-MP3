#!/usr/bin/env python3
"""
Dublador Web - Painel web para dublagem com clonagem de voz
============================================================
Painel web (Flask) que usa dublar.py / dublar_yt.py como motor:
...
Requisitos adicionais (leves):  pip install flask
Para dublar de fato:           pip install -r requirements.txt  + ffmpeg no PATH
"""
...
ENGINES = {"chatterbox": "Chatterbox (clonagem)", "edge": "Edge TTS (leve)"}
    ...
    try:
        ...
        with _JOBS_LOCK:
            if len(_JOBS) >= MAX_TOTAL_JOBS:
                oldest = sorted(_JOBS.values(), key=lambda j: j.created)[0]
